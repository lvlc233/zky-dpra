...
Revision ID: c607ef697b00
Revises: c1ff67eb6a74
Create Date: 2026-03-07 07:38:20.815931
...
revision: str = 'c607ef697b00'
down_revision: Union[str, Sequence[str], None] = 'c1ff67eb6a74'
...
def upgrade() -> None:
    ...
    # DO NOT DROP CHECKPOINT TABLES - They are managed by langgraph-checkpoint-postgres
    ...
    op.alter_column('paper_chunks', 'embedding',
               ...
               comment='向量Embedding(本地模型默认1024维)',
...
def downgrade() -> None:
    ...
    op.alter_column('paper_chunks', 'embedding',
               ...
               existing_comment='向量Embedding(本地模型默认1024维)',
               existing_nullable=True)
